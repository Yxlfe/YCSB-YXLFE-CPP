...
class DB {
 public:
  ...
  DB() : props_(nullptr) {}
  DB(utils::Properties* props) : props_(props) {}
  ///
  ...
  {
    // std::cout << "this->wrapper->props_dbname: " << this->props_->GetProperty("dbname", "basic") << std::endl;
    // std::cout << "other->wrapper->props_dbname: " << other.props_->GetProperty("dbname", "basic") << std::endl;
    // std::cout << "this->wrapper->db_->props_dbname: " << this->GetProps()->GetProperty("dbname", "basic") << std::endl;
    // std::cout << "other->wrapper->db_->props_dbname: " << other.GetProps()->GetProperty("dbname", "basic") << std::endl;
    return !(this->GetProps()->GetProperty("dbname", "basic") == other.GetProps()->GetProperty("dbname", "basic"));
  }
  ...
  virtual utils::Properties * GetProps() const{
    return props_;
  }
